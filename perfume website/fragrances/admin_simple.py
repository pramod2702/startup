...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ['user', 'phone_number', 'login_method', 'is_verified', 'created_at']
...
class TrialPackAdmin(admin.ModelAdmin):
    list_display = ['name', 'email', 'phone', 'product_name', 'amount', 'order_status', 'created_at']
    list_filter = ['order_status', 'payment_method', 'created_at']
    search_fields = ['name', 'email', 'phone', 'product_name']
    ordering = ['-created_at']
    
    def product_name(self, obj):
        return obj.product_name or 'Trial Pack'
    product_name.short_description = 'Product'
